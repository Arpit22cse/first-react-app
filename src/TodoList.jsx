...
function Todo(){
  ...
  return <>
    ...
    <ul className="grid grid-cols-1 text-sky-400 font-mono text-2xl justify-items-center">
      ...
      <li className="flex justify-text-centre p-0 min-w-full m-2 shadow-md bg-slate-700  border-4 ml-4 mr-4 border-green-300 hover:shadow-green-200 " id={index}><span className="ml-2 flex basis-full">{index+1}: {task}</span>
